...
public void prepareConnector(string groupName){
    connector = GridTerminalSystem.GetBlockWithName("Connector " + groupName) as IMyShipConnector; 
}
